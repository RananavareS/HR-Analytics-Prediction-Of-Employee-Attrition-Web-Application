...
#from streamlit_pandas_profilling  import st_profile_report
...
plot=df.hvplot.hist(y='DistanceFromHome', by='Attrition', subplots=False, width=600, height=300, bins=30)
plot1=df.hvplot.hist(y='Education', by='Attrition', subplots=False, width=600, height=300)
plot2=df.hvplot.hist(y='RelationshipSatisfaction', by='Attrition', subplots=False, width=600, height=300)
plot3=df.hvplot.hist(y='EnvironmentSatisfaction', by='Attrition', subplots=False, width=600, height=300)
...
plot6=df.hvplot.hist(y='NumCompaniesWorked', by='Attrition', subplots=False, width=600, height=300)
plot7=df.hvplot.hist(y='PercentSalaryHike', by='Attrition', subplots=False, width=600, height=300)
plot8=df.hvplot.hist(y='StockOptionLevel', by='Attrition', subplots=False, width=600, height=300)
plot9=df.hvplot.hist(y='TrainingTimesLastYear', by='Attrition', subplots=False, width=600, height=300)
plot10=df.hvplot.hist(y='Age', by='Attrition', subplots=False, width=600, height=300, bins=35)
plot11=df.hvplot.hist(y='MonthlyIncome', by='Attrition', subplots=False, width=600, height=300, bins=50)
plot12=df.hvplot.hist(y='YearsAtCompany', by='Attrition', subplots=False, width=600, height=300, bins=35)
plot13=df.hvplot.hist(y='TotalWorkingYears', by='Attrition', subplots=False, width=600, height=300, bins=35)
show(hv.render(plot))
